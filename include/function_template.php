...
function template($file) {
	...
	$tplfile = CORP_ROOT.$tpldir.'/'.$file.'.htm';
	$objfile = CORP_ROOT.'./cache/templates/'.$styleid.'_'.$file.'.tpl.php';
...
function parse_template($tplfile) {
    ...
    $template = "<?php if(!defined('IN_CORP')) exit('Access Denied'); checktplrefresh('$tplfile', ".time()."); ?>\n$template";
